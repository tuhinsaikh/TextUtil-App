...
export default function About(props){
    return(
        ...
        <div className="accordion accordion-flush border border-secondary" id="accordionFlushExample">
            ...
            <div className={`accordion-item bg-${props.mode} text-${props.mode==='dark' ? 'light':'dark'}` }>
                <h2 className="accordion-header">
                <button className={`accordion-button collapsed bg-${props.mode} text-${props.mode==='dark' ? 'light':'dark'}`} type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree" aria-expanded="false" aria-controls="flush-collapseThree">
                    Accordion Item #3
                </button>
                </h2>
